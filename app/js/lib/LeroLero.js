...
function LeroLero() {
	...
	var tab1 = new Array(
			...
			"o desenvolvimento contínuo de distintas formas de atução ",
			...
			"a crescente influência da média ",
	...
	var tab3 = new Array(
			...
			"de alternativas às soluçães ortodoxas.",
	...
	this.proximaFrase = function() {

		return tab0.getRandom() + tab1.getRandom() + tab2.getRandom() + tab3.getRandom();
